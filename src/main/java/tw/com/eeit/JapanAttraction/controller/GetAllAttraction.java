...
@WebServlet("/ShowAllAttraction")
public class GetAllAttraction extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher(PathConverter.convertToWebInfPath("ShowAllAttraction")).forward(request, response);
	}
